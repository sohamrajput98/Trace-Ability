...
export default function TraceAbilityDashboard() {
  ...
  return (
    <BootSequence>
      {/* SIDEBAR */}
      <aside className="hidden lg:flex w-80 border-r border-white/5 p-8 flex-col gap-8 bg-[#05070A] overflow-y-auto shrink-0 relative shadow-2xl">
        <section className="space-y-6 z-10">
          
          {/* PRIMARY MODEL CARD */}
          <div>
            <h3 className="text-[#FFD700] text-[12px] font-black uppercase tracking-[0.3em] mb-4 flex items-center gap-2">
              <svg width="20" height="20" viewBox="0 0 64 48" className="ekg-svg overflow-visible">
                <polyline stroke="rgba(216, 216, 15, 0.21)" strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round" points="0 24, 14 24, 22 48, 43 0, 50 24, 64 24" />
                <polyline className="ekg-front" stroke="#f2ce05ef" strokeWidth="8" fill="none" strokeLinecap="round" strokeLinejoin="round" points="0 24, 14 24, 22 48, 43 0, 50 24, 64 24" style={{ filter: 'drop-shadow(0 0 3px #FFD700)' }} />
              </svg>
              System Status
            </h3>
            <div className="bg-[black] p-5 rounded-md border border-[#FFD700]/20 shadow-[0_4px_20px_rgba(0,0,0,0.5)] relative overflow-hidden group hover:border-[#FFD700]/50 transition-all">
              <div className="relative z-10">
                <p className="text-[10px] text-gray-300 uppercase font-bold tracking-widest mb-2">Primary Model</p>
          ...
          <div>
            <h3 className="text-[#FFD700] text-[12px] font-black uppercase tracking-[0.3em] mb-4 flex items-center gap-2">
              <Database size={18} /> Core Metrics
            </h3>
            <div className="bg-[black] p-6 rounded-md border border-[#FFD700]/20 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-[#FFD700]/50 transition-all">
              <p className="text-[11px] text-[#FFD700] uppercase font-black tracking-widest mb-1">Avg Confidence</p>
              <p className="text-4xl font-black text-white drop-shadow-[0_0_10px_rgba(212,175,55,0.3)]">{avgTrust}<span className="text-[#FFD700] text-xl ml-1">%</span></p>
            </div>
  ...
  <div className="bg-[black] p-4 border border-[#FFD700]/20 rounded-md relative overflow-hidden shadow-[inset_0_0_20px_rgba(0,0,0,0.8),0_4px_15px_rgba(0,0,0,0.5)] hover:border-[#FFD700]/50 transition-all">
    ...
    <div className="h-24 overflow-hidden text-[10px] font-mono font-bold tracking-widest leading-relaxed relative">
      ...
      <div className="animate-[scrollY_15s_linear_infinite] flex flex-col gap-2 text-gray-300">
        ...
        <p className="text-[#FFD700] drop-shadow-[0_0_5px_rgba(212,175,55,0.8)]"><span className="text-[#FFD700]/70">{'>'}</span> SIGNATURE::APPENDING... OK</p>
        <p><span className="text-[#FFD700]/70">{'>'}</span> VALIDATING_NONCE::77197</p>
        ...
        <p aria-hidden="true"><span className="text-[#FFD700]/70">{'>'}</span> VALIDATING_NONCE::77197</p>
      </div>
    </div>
  </div>
</div>
          ...
          <div className="mt-0 flex flex-col items-center justify-center opacity-90 relative">
            <div className="absolute w-45 h-45 bg-[black]/5 rounded-full blur-2xl pointer-events-none" />
            ...
            <div className="relative flex items-center justify-center w-45 h-45">
                ...
                <div className="svg-frame">
                  <svg style={{ "--i": 0, "--j": 0 } as any} viewBox="0 0 344 344">
                    <g id="out1">
                      ...
                      <path mask="url(#path-1-inside-1_111_3212)" strokeMiterlimit={16} strokeWidth={2} stroke="#FFD700" d="M72 172C72 116.772 116.772 72 172 72C227.228 72 272 116.772 272 172C272 227.228 227.228 272 172 272C116.772 272 72 227.228 72 172ZM197.322 172C197.322 158.015 185.985 146.678 172 146.678C158.015 146.678 146.678 158.015 146.678 172C146.678 185.985 158.015 197.322 172 197.322C185.985 197.322 197.322 185.985 197.322 172Z" />
                    </g>
                  </svg>

                  <svg style={{ "--i": 1, "--j": 1 } as any} viewBox="0 0 344 344">
                    <g id="out2">
                    ...
                    <svg style={{ "--i": 2, "--j": 4 } as any} viewBox="0 0 344 344">
                      ...
                      <path fill="#FFD700" d="M172 166.445C175.068 166.445 177.556 168.932 177.556 172C177.556 175.068 175.068 177.556 172 177.556C168.932 177.556 166.444 175.068 166.444 172C166.444 168.932 168.932 166.445 172 166.445ZM172 177.021C174.773 177.021 177.021 174.773 177.021 172C177.021 169.227 174.773 166.979 172 166.979C169.227 166.979 166.979 169.227 166.979 172C166.979 174.773 169.227 177.021 172 177.021Z" id="center" />
                    </svg>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col items-center gap-3 z-10">
                ...
                <p className="text-[11px] text-[#FFD700]/100 uppercase font-black tracking-[0.3em]">
                  Scanning Telemetry
                </p>
              </div>
            </div>
        ...
        <section className="mt-auto z-10 bg-[black] p-4 border border-[#FFD700]/20 rounded-md shadow-lg">
          <p className="text-[9px] text-gray-200 leading-relaxed uppercase tracking-widest font-medium">
      ...
      {/* MAIN LOGS AREA */}
      <main id="main-scroll-area" className="flex-1 bg-[#05070A] overflow-y-auto overflow-x-hidden p-6 md:p-10 custom-scrollbar scroll-smooth">
        <div className="max-w-4xl mx-auto space-y-12 pb-20 pt-10"> 
          {loading ? (
            <div className="h-40 flex flex-col items-center justify-center gap-6">
              ...
              <div className="text-[#FFD700] font-mono text-[10px] animate-pulse uppercase tracking-[0.5em]">
